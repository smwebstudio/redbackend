...
class CreateCDailyPriceInRurTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_daily_price_in_rur', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_daily_price_in_rur');
    }
}
