...
class CreateCHeatingSystemTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_heating_system_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_heating_system_type');
    }
}
