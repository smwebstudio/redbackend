...
class CreateCCommercialPurposeTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_commercial_purpose_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_commercial_purpose_type');
    }
}
