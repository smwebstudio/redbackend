...
class CreateEstateTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('estate', function (Blueprint $table) {
            ...
            $table->integer('location_country_id')->nullable()->index('FK_ESTATE_C_LOCATION_COUNTRY');
            $table->integer('location_province_id')->nullable()->index('FK_ESTATE_C_LOCATION_PROVINCE');
            $table->integer('location_city_id')->nullable()->index('FK_ESTATE_C_LOCATION_CITY');
            $table->integer('location_community_id')->nullable()->index('FK_ESTATE_C_LOCATION_COMMUNITY');
            $table->integer('location_street_id')->nullable()->index('FK_ESTATE_C_LOCATION_STREET');
            $table->integer('estate_type_id')->nullable()->index('FK_ESTATE_C_ESTATE_TYPE');
            $table->float('area_total', 24, 1)->nullable();
            $table->float('old_price', 24, 0)->nullable();
            $table->float('price', 24, 0)->nullable();
            $table->integer('currency_id')->nullable()->index('FK_ESTATE_C_CURRENCY');
            $table->integer('seller_id')->nullable()->index('FK_ESTATE_C_CONTACT');
            $table->float('area_residential', 24, 1)->nullable();
            $table->integer('registered_right_id')->nullable()->index('FK_ESTATE_C_REGISTERED_RIGHTS');
            $table->integer('repairing_type_id')->nullable()->index('FK_ESTATE_BUILDING_C_REMONT_TYPE');
            $table->integer('room_count')->nullable();
            $table->integer('building_type_id')->nullable()->index('FK_ESTATE_BUILDING_C_BUILDING_TYPE');
            ...
            $table->integer('exterior_design_type_id')->nullable()->index('FK_ESTATE_HOUSE_C_EXTERIOR_DESIGN_TYPE');
            $table->integer('elevator_type_id')->nullable()->index('FK_ESTATE_BUILDING_C_ELEVATOR_TYPE');
            $table->integer('year_id')->nullable()->index('FK_ESTATE_BUILDING_C_YEAR');
            $table->integer('heating_system_type_id')->nullable()->index('FK_ESTATE_BUILDING_C_HEATING_SYSTEM_TYPE');
            $table->integer('parking_type_id')->nullable()->index('FK_ESTATE_BUILDING_C_PARKING_TYPE');
            $table->integer('service_fee_type_id')->nullable()->index('FK_ESTATE_BUILDING_C_SERVICE_FEE_TYPE');
            ...
            $table->integer('roof_type_id')->nullable()->index('FK_ESTATE_HOUSE_C_ROOF_TYPE');
            $table->integer('floor_count_id')->nullable();
            $table->integer('house_building_type_id')->nullable()->index('FK_ESTATE_HOUSE_C_HOUSE_BUILDING_TYPE');
            $table->boolean('roof_repaired')->nullable();
            $table->integer('roof_material_type_id')->nullable()->index('FK_ESTATE_HOUSE_C_ROOF_MATERIAL_TYPE');
            $table->integer('fence_type_id')->nullable()->index('FK_ESTATE_LAND_C_FENCE_TYPE');
            $table->integer('communication_type_id')->nullable()->index('FK_ESTATE_HOUSE_C_COMMUNICATION');
            $table->integer('front_with_street_id')->nullable()->index('FK_ESTATE_LAND_C_FRONT_WITH_STREET');
            $table->integer('road_way_type_id')->nullable()->index('FK_ESTATE_LAND_C_ROAD_WAY_TYPE');
            $table->integer('commercial_purpose_type_id')->nullable();
            $table->integer('communication_id')->nullable()->index('FK_ESTATE_LAND_C_COMMUNICATION');
            $table->integer('land_structure_type_id')->nullable()->index('FK_ESTATE_LAND_C_LAND_STRUCTURE_TYPE');
            $table->integer('land_type_id')->nullable()->index('FK_ESTATE_LAND_C_LAND_TYPE');
            ...
            $table->integer('estate_status_id')->nullable()->index('estate_status_id');
            $table->date('status_changed_on')->nullable();
            $table->integer('status_id_before_archive')->nullable()->index('status_id_before_archive');
            ...
            $table->dateTime('last_modified_on')->nullable()->index('last_modified_on');
            ...
            $table->boolean('is_hot_offer')->nullable()->index('IS_HOT_OFFER');
            ...
            $table->boolean('is_estate_commercial_land')->nullable();
            $table->integer('courtyard_improvement_id')->nullable();
            $table->integer('distance_public_objects_id')->nullable();
            $table->integer('building_window_count_id')->nullable();
            $table->integer('temporary_agent_id')->nullable();
            $table->date('temporary_agent_date')->nullable();
            $table->integer('temporary_visits_count')->nullable();
            $table->boolean('apartment_construction')->nullable();
            ...
            $table->date('price_down_on')->nullable();
            $table->boolean('is_public_text_generation')->nullable();
        });
    }
