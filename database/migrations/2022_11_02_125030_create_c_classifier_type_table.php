...
class CreateCClassifierTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_classifier_type', function (Blueprint $table) {
            $table->integer('id')->primary();
            $table->boolean('is_deleted')->nullable();
            $table->date('last_modified_on')->nullable();
            $table->integer('version')->nullable();
            $table->char('sort_id', 20)->nullable();
            $table->string('symbolic_name', 100)->nullable();
    ...
    {
        Schema::dropIfExists('c_classifier_type');
    }
}
