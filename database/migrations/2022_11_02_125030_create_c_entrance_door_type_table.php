...
class CreateCEntranceDoorTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_entrance_door_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_entrance_door_type');
    }
}
