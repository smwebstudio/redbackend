...
class CreateCSeparateEntranceTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_separate_entrance_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_separate_entrance_type');
    }
}
