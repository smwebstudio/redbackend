...
class CreateCEvaluationBuildingProjectTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_evaluation_building_project', function (Blueprint $table) {
            ...
            $table->integer('evaluation_building_type_id')->nullable();
        });
    }
