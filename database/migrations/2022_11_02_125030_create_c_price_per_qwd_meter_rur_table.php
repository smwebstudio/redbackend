...
class CreateCPricePerQwdMeterRurTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_price_per_qwd_meter_rur', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_price_per_qwd_meter_rur');
    }
}
