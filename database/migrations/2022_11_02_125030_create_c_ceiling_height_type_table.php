...
class CreateCCeilingHeightTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_ceiling_height_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_ceiling_height_type');
    }
}
