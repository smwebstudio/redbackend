...
class CreateCBuildingFloorTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_building_floor_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_building_floor_type');
    }
}
