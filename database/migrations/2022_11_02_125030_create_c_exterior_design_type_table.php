...
class CreateCExteriorDesignTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_exterior_design_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_exterior_design_type');
    }
}
