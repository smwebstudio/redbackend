...
class CreateCRoofMaterialTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_roof_material_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_roof_material_type');
    }
}
