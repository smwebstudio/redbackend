...
class CreateCBuildingProjectTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_building_project_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_building_project_type');
    }
}
