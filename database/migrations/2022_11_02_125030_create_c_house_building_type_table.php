...
class CreateCHouseBuildingTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_house_building_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_house_building_type');
    }
}
