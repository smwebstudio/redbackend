...
class CreateCCommunicationTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_communication_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_communication_type');
    }
}
