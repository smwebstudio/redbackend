...
class CreateCDistancePublicObjectsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_distance_public_objects', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_distance_public_objects');
    }
}
