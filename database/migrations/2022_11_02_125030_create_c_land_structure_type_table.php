...
class CreateCLandStructureTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_land_structure_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_land_structure_type');
    }
}
