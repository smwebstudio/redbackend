...
class CreateCBuildingWindowCountTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_building_window_count', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_building_window_count');
    }
}
