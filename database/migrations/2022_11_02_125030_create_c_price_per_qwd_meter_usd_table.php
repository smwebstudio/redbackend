...
class CreateCPricePerQwdMeterUsdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_price_per_qwd_meter_usd', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_price_per_qwd_meter_usd');
    }
}
