...
class CreateCDailyPriceInUsdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('c_daily_price_in_usd', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('c_daily_price_in_usd');
    }
}
