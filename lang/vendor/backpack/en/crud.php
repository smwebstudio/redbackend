...
return [
    ...
    */
    ...
    // Forms
    'save_action_save_and_new'         => 'Պահպանել և ավելացնել նորը',
    'save_action_save_and_edit'        => 'Պահպանել',
    'save_action_save_and_back'        => 'Պահպանել և հետ',
    'save_action_save_and_preview'     => 'Պահպանել և դիտել',
    'save_action_changed_notification' => 'Default behaviour after saving has been changed.',

    // Create form
    'add'                 => 'Նոր',
    'back_to_all' => 'Վերադառնալ բոլորին ',
    'cancel' => 'Չեղարկել',
    'add_a_new' => 'Ավելացնել նոր ',
    ...
    // CRUD table view
    'all' => 'Բոլորը ',
    'in_the_database' => 'տվյալների բազայում',
    'list' => 'Ցուցակ',
    'reset' => 'Մաքրել',
    'actions' => '',
    'preview' => 'Դիտել',
    'delete' => 'Ջնջել',
    'admin' => 'Red Group',
    'details_row' => 'Սա մանրամասն տողն է։ Փոխեք այսպիսին, ինչպես ուզում եք։',
    'details_row_loading_error' => 'Մանրամասների բեռնման ընթացքում ստացվեց սխալ։ Կրկին փորձեք, ուղղեք։',
    'clone' => 'Պատճենել',
...
//    ],
    ...
    'search' => 'Որոնում',
    'zeroRecords' => 'Որոնվող գրառումներ չեն գտնվել',
    'paginate' => [
        'first' => 'Առաջին',
        'last' => 'Վերջին',
        'next' => 'Հաջորդ',
    ...
    'aria' => [
        'sortAscending' => ': ակտիվացնել սյունակը աճման կարգով',
        'sortDescending' => ': ակտիվացնել սյունակը նվազման կարգով',
    ],
