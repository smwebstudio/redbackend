...
/**
 * Class CEvaluationBuildingProject
 *
 * @property int $id
 ...
 * @property int|null $evaluation_building_type_id
 *
 * @package App\Models
 */
class CEvaluationBuildingProject extends Model
{
	protected $table = 'c_evaluation_building_project';
	...
	protected $casts = [
		...
		'created_by' => 'int',
		'evaluation_building_type_id' => 'int'
	];
